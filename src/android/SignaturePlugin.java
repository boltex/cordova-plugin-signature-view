...
public class SignaturePlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        if (action.equals("new")) {
            ...
            String clear = "Reset";
            /*
             * if (args.length() >= 4) { htmlFile = args.getString(3); }
             * 
             * if (args.length() >= 3) { clear = args.getString(2); }
             * 
             * if (args.length() >= 2) { save = args.getString(1); }
             * 
            ...
            SignatureDialogFragment signatureDialogFragment = new SignatureDialogFragment(title, save, clear, htmlFile,
                    callbackContext);
